...
export default function Footer() {
  ...
  return (
    <div className={`${styles.footer} ${darkMode ? styles.dark : ""}`}>
      <div className={`${styles.link} ${darkMode ? styles.dark : ""}`}>
        <a href="https://zero-base.co.kr/">제로베이스</a>
      </div>
      <ul className={`${styles.flex} ${darkMode ? styles.dark : ""}`}>
        <li>
          <svg
            viewBox="0 0 38 24"
      ...
      <div className={`${styles.sns} ${darkMode ? styles.dark : ""}`}>
        <a
        ...
        >
          <label>
            <FaFacebookF
              className={`${styles.icons} ${darkMode ? styles.dark : ""}`}
            />
          </label>
        </a>
        <a
        ...
        <a href="https://github.com/oinochoe" target="_blank" data-tip="github">
          <label>
            <BsGithub
              className={`${styles.icons} ${darkMode ? styles.dark : ""}`}
            />
      ...
      <div>
        <p className={`${styles.copyright} ${darkMode ? styles.dark : ""}`}>
